 ...
 * </pre>
 *
 * @see br.alandoni.pdfcompare.android.PdfComparator#withEnvironment(Environment)
 */
public class SimpleEnvironment implements Environment {
    ...
    public SimpleEnvironment setExpectedColor(int expectedColor) {
    ...
    public SimpleEnvironment setActualColor(int actualColor) {
